...
export default defineComponent({
  ...
  props: {
    ...
    type: {
      type: String,
      default: RButtonPropTypes.primary,
      validator: (value: RButtonPropType) =>
        Object.values(RButtonPropTypes).includes(value),
    },
    /** Rozmiar przycisku: small, medium, large. Domyślny rozmiar: medium */
    size: {
      type: String,
      default: 'medium',
      validator: (value: RButtonPropSize) =>
        Object.values(RButtonPropSizes).includes(value),
    },
